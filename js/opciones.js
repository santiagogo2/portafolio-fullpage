var seccionesPagina = new fullpage('#fullpage',{
	...
	// ──────────────────────────────────────────────────
		 ...
		 anchors: ['inicio', 'quienesSomos', 'plataformaEstrategica', 'contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
		 navigationTooltips: ['Inicio', 'Quienes Somos', 'Plataforma Estratégica', 'Contacto'], // Tooltips que mostrara por cada boton.
